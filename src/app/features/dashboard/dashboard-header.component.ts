      ...
      @if (showFilters()) {
        <div class="flex gap-2 md:min-w-[420px]">
          <div class="input-with-icon flex-1">
            <svg class="icon h-4 w-4 text-muted-foreground" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
